...
`datefixR` also supports dates provided in different languages and translated
warning and error messages. The following languages are currently supported:
...
Numeric representations of dates, as used by either Excel or by R, are also
supported. 
