...
datefixR is most commonly used to standardize columns of date data in a
data frame or tibble. For this demonstration, we will generate a data
...
We can standardize these date columns by using the `fix_dates()`
