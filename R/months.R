###############################################################
#-        List of month names in different languages.        -#
#- Please feel free to contribute months in other languages! -#
###############################################################

months <- new.env()
months$months <-list()
months$months[[1]] <- c("january",
                        "janvier",
                        "janv",
                        "januar",
                        "j\u00E4nner",
...
months$months[[9]] <- c("september",
                        "septembre",
                        "septiembre",
                        "set",
                        "sept",
                        "sep")
months$months[[10]] <- c("october",
                         "octobre",
                         "oktober",
                         "okt",
                         "octubre",
